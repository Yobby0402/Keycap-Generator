...
class ParameterPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        self.stem_cross_width_spin.setValue(1.3)
        ...
        # 卫星轴十字宽度、十字长度、圆柱直径、连接器深度（与十字轴参数对应）
        stab_cross_layout = QHBoxLayout()
        self._stabilizer_cross_width_label = QLabel("")
        stab_cross_layout.addWidget(self._stabilizer_cross_width_label)
        self.stabilizer_cross_width_spin = QDoubleSpinBox()
        self.stabilizer_cross_width_spin.setRange(0.5, 3.0)
        self.stabilizer_cross_width_spin.setValue(1.3)
        self.stabilizer_cross_width_spin.setDecimals(1)
        self.stabilizer_cross_width_spin.setSuffix(" mm")
        self.stabilizer_cross_width_spin.valueChanged.connect(self.on_parameter_changed)
        stab_cross_layout.addWidget(self.stabilizer_cross_width_spin)
        self._stabilizer_cross_length_label = QLabel("")
        stab_cross_layout.addWidget(self._stabilizer_cross_length_label)
        self.stabilizer_cross_length_spin = QDoubleSpinBox()
        self.stabilizer_cross_length_spin.setRange(2.0, 8.0)
        self.stabilizer_cross_length_spin.setValue(4.0)
        self.stabilizer_cross_length_spin.setDecimals(1)
        self.stabilizer_cross_length_spin.setSuffix(" mm")
        self.stabilizer_cross_length_spin.valueChanged.connect(self.on_parameter_changed)
        stab_cross_layout.addWidget(self.stabilizer_cross_length_spin)
        stabilizer_layout.addLayout(stab_cross_layout)
        stab_cylinder_layout = QHBoxLayout()
        self._stabilizer_cylinder_label = QLabel("")
        stab_cylinder_layout.addWidget(self._stabilizer_cylinder_label)
        self.stabilizer_cylinder_spin = QDoubleSpinBox()
        self.stabilizer_cylinder_spin.setRange(2.0, 8.0)
        self.stabilizer_cylinder_spin.setValue(4.0)
        self.stabilizer_cylinder_spin.setDecimals(1)
        self.stabilizer_cylinder_spin.setSuffix(" mm")
        self.stabilizer_cylinder_spin.valueChanged.connect(self.on_parameter_changed)
        stab_cylinder_layout.addWidget(self.stabilizer_cylinder_spin)
        self._stabilizer_depth_label = QLabel("")
        stab_cylinder_layout.addWidget(self._stabilizer_depth_label)
        self.stabilizer_depth_spin = QDoubleSpinBox()
        self.stabilizer_depth_spin.setRange(2.0, 12.0)
        self.stabilizer_depth_spin.setValue(5.0)
        self.stabilizer_depth_spin.setDecimals(1)
        self.stabilizer_depth_spin.setSuffix(" mm")
        self.stabilizer_depth_spin.valueChanged.connect(self.on_parameter_changed)
        stab_cylinder_layout.addWidget(self.stabilizer_depth_spin)
        stabilizer_layout.addLayout(stab_cylinder_layout)
    ...
    def retranslateUi(self):
        ...
        self._stabilizer_cross_width_label.setText(t("十字宽度:", "Cross width:"))
        self._stabilizer_cross_length_label.setText(t("十字长度:", "Cross length:"))
        self._stabilizer_cylinder_label.setText(t("圆柱直径:", "Cylinder diam.:"))
        self._stabilizer_depth_label.setText(t("连接器深度:", "Stem depth:"))
    ...
    def _update_params_from_ui(self):
        ...
        self.params.stabilizer_cross_width = self.stabilizer_cross_width_spin.value()
        self.params.stabilizer_cross_length = self.stabilizer_cross_length_spin.value()
        self.params.stabilizer_cylinder_diameter = self.stabilizer_cylinder_spin.value()
        self.params.stabilizer_depth = self.stabilizer_depth_spin.value()
    ...
    def load_default_parameters(self):
        ...
        # 默认连接器/十字轴参数
        self.stem_enabled_checkbox.setChecked(self.settings.get_default_stem_enabled())
        self.params.stem_enabled = self.settings.get_default_stem_enabled()
        self.stem_combo.setCurrentText(self.settings.get_default_stem_type())
        self.params.stem_type = self.settings.get_default_stem_type()
        self.stem_height_spin.setValue(self.settings.get_default_stem_height())
        self.params.stem_height = self.settings.get_default_stem_height()
        self.stem_cylinder_spin.setValue(self.settings.get_default_stem_cylinder_diameter())
        self.params.stem_cylinder_diameter = self.settings.get_default_stem_cylinder_diameter()
        self.stem_cross_width_spin.setValue(self.settings.get_default_stem_cross_width())
        self.params.stem_cross_width = self.settings.get_default_stem_cross_width()
        self.stem_cross_length_spin.setValue(self.settings.get_default_stem_cross_length())
        self.params.stem_cross_length = self.settings.get_default_stem_cross_length()
        self.params.top_thickness = self.settings.get_default_top_thickness()
        self.params.corner_radius = self.settings.get_default_corner_radius()
        
        # 默认弧面参数
        self.curved_top_enabled_check.setChecked(self.settings.get_default_curved_top_enabled())
        self.params.curved_top_enabled = self.settings.get_default_curved_top_enabled()
        self.curved_x_check.setChecked(self.settings.get_default_curved_top_x_enabled())
        self.params.curved_top_x_enabled = self.settings.get_default_curved_top_x_enabled()
        self.curved_y_check.setChecked(self.settings.get_default_curved_top_y_enabled())
        self.params.curved_top_y_enabled = self.settings.get_default_curved_top_y_enabled()
        self.curved_x_radius_spin.setValue(self.settings.get_default_curved_top_x_radius())
        self.params.curved_top_x_radius = self.settings.get_default_curved_top_x_radius()
        self.curved_y_radius_spin.setValue(self.settings.get_default_curved_top_y_radius())
        self.params.curved_top_y_radius = self.settings.get_default_curved_top_y_radius()
        direction_map = {"convex": t("向上凸起", "Convex up"), "concave": t("向下凹陷", "Concave down")}
        self.curved_direction_combo.setCurrentText(
            direction_map.get(self.settings.get_default_curved_top_direction(), t("向上凸起", "Convex up")))
        self.params.curved_top_direction = self.settings.get_default_curved_top_direction()
        
        # 默认卫星轴参数
        self.stabilizer_enabled_checkbox.setChecked(self.settings.get_default_stabilizer_enabled())
        self.params.stabilizer_enabled = self.settings.get_default_stabilizer_enabled()
        self.stabilizer_length_spin.setValue(self.settings.get_default_stabilizer_length())
        self.params.stabilizer_length = self.settings.get_default_stabilizer_length()
        self.stabilizer_cross_width_spin.setValue(self.settings.get_default_stabilizer_cross_width())
        self.params.stabilizer_cross_width = self.settings.get_default_stabilizer_cross_width()
        self.stabilizer_cross_length_spin.setValue(self.settings.get_default_stabilizer_cross_length())
        self.params.stabilizer_cross_length = self.settings.get_default_stabilizer_cross_length()
        self.stabilizer_cylinder_spin.setValue(self.settings.get_default_stabilizer_cylinder_diameter())
        self.params.stabilizer_cylinder_diameter = self.settings.get_default_stabilizer_cylinder_diameter()
        self.stabilizer_depth_spin.setValue(self.settings.get_default_stabilizer_depth())
        self.params.stabilizer_depth = self.settings.get_default_stabilizer_depth()
